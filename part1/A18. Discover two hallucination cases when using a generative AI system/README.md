...
## 2. Fake legal citation case

Another hallucination case happened when lawyers used generative AI to help write legal documents. The AI created fake court cases and fake legal citations that did not really exist. These false citations were submitted to court, which caused serious problems.
